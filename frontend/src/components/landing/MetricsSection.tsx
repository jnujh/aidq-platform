...
// 8개 지표 deep-dive — 측정 공식 · 임계값 · 학술 출처 · 손상 (ResearchBackedSection에서 이동)
type DeepMetric = {
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          >
            ...
            <br />
            DSC v5 framework는 6개 셀(3 데이터 타입 × 2 작업)에 대해 각각의 지표 세트를 학술 근거와 함께 freeze해 관리합니다.
          </p>
        </div>
        ...
        <div style={{ marginBottom: 64 }}>
          <Flex gap={18} wrap="wrap" align="stretch">
            {DEEP_METRICS.map(({ Icon, key, ko, oneLine, formula, threshold, source, damageIfLow }) => (
              <div
                key={key}
                style={{
        ...
        <div style={{ marginTop: 88 }}>
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            ...
            >
              8개 지표·셀별 가중치·임계값은 모두 <strong style={{ color: BRAND.colors.primaryDark }}>국제 표준</strong>과 <strong style={{ color: BRAND.colors.primaryDark }}>동료심사 논문</strong>에 직접 매핑됩니다.
              <br />
